$(function(){
	$("main").ready(function(){
		...
		var url = "http://linkdata.org/api/1/rdf1s8295i/kanagawa_corona_hospital_rdf.json?callback=?";//←各チームの企画によって変更！
		var resource_uri = "http://linkdata.org/resource/1/rdf1s8295i"; //データIDにあたるURLの部分をここに書く
		var label_uri ="http://www.w3.org/2000/01/rdf-schema#label"; //ラベルとなっている項目のURI(変更の必要なし）
		var addr_uri ="address"; //住所の項目を取り出すためのURI
