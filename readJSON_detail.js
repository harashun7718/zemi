$(function(){
	$("#main_content").ready(function(){
		...
		var url = "http://www.shonan.bunkyo.ac.jp/~b8p31072/proa2019-project2_example.json";
		...
		$.getJSON(url,function(data){ //urlの文字列のURLからidまたはqで指定した値を持つJSONオブジェクトを取得
			...
			if($("main").get(0)){ //<main>～</main>があったら
				...
				if($("#map_here").get(0)){//<div id="map_here">のタグがあったら
					...
					// 描画する(Copyrightは消しちゃダメよ)$(function(){
	$("#main_content").ready(function(){
		...
		$.getJSON(url,function(data){ //urlの文字列のURLからidまたはqで指定した値を持つJSONオブジェクトを取得
			...
			if($("main").get(0)){ //<main>～</main>があったら
				...
				//<img id="thumnail_img">タグのsrcの値をサムネイル画像のファイルに設定（photosフォルダに”画像名_thum.jpg”があるとする）
				$("img#thumnail_img").attr("src","./photos/"+obj.image_file+".jpg");
				...
				if($("p#overview").get(0)){//<p id="detail"></p>のタグがあったら
					$("p#overview").html(obj.overview); //detail（DBではカラム）の値を変更
				}
				...
				if($("div#image_list").get(0)){//<div id="image_list">のタグがあったら
					...
					if(obj.image_file1 != null && obj.image_file1!=""){
						var img1_tag = '<a href="./photos/'+obj.image_file1+'.jpg" data-lightbox="image-list">';
						img1_tag += '<img src="./photos/'+obj.image_file1+'_thum.jpg" class="col-3 mb-5 "/></a>';
						$("div#image_list").append(img1_tag);
					}

					if(obj.image_file2 != null && obj.image_file2!=""){
						var img2_tag = '<a href="./photos/'+obj.image_file2+'.jpg" data-lightbox="image-list">';
						img2_tag += '<img src="./photos/'+obj.image_file2+'_thum.jpg" class="col-3 mb-5 "/></a>';
						$("div#image_list").append(img2_tag);
					}

					if(obj.image_file3 != null && obj.image_file3!=""){
						var img3_tag = '<a href="./photos/'+obj.image_file3+'.jpg" data-lightbox="image-list">';
						img3_tag += '<img src="./photos/'+obj.image_file3+'_thum.jpg" class="col-3 mb-5 "/></a>';
						$("div#image_list").append(img3_tag);
					}
					if(obj.image_file4 != null && obj.image_file4!=""){
						var img4_tag = '<a href="./photos/'+obj.image_file4+'.jpg" data-lightbox="image-list">';
						img4_tag += '<img src="./photos/'+obj.image_file4+'_thum.jpg" class="col-3 mb-5 "/></a>';
						$("div#image_list").append(img4_tag);
					}
					if(obj.image_file5 != null && obj.image_file5!=""){
						var img5_tag = '<a href="./photos/'+obj.image_file5+'.jpg" data-lightbox="image-list">';
						img5_tag += '<img src="./photos/'+obj.image_file5+'_thum.jpg" class="col-3 mb-5 "/></a>';
						$("div#image_list").append(img5_tag);
					}
					if(obj.image_file6 != null && obj.image_file6!=""){
						var img6_tag = '<a href="./photos/'+obj.image_file6+'.jpg" data-lightbox="image-list">';
						img6_tag += '<img src="./photos/'+obj.image_file6+'_thum.jpg" class="col-md-12 "/></a>';
						$("div#image_list").append(img6_tag);
					}
