$(function(){
	$("#main_content").ready(function(){ //<div id="main_content">~</div>の読み込みが完了したら
		...
		var url = "http://linkdata.org/api/1/rdf1s127i/OPENDATA_Japan_rdf.json?callback=?";//←各チームの企画によって変更！
		var resource_uri = "http://linkdata.org/resource/rdf1s127i"; //データIDにあたるURLの部分をここに書く
